...
export const DiscordArrowIcon = ({ size = "24", className }) => {
  return (
...
export const DiscordHashIcon = ({ size = "24", className }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const DiscordDownloadIcon = ({ className }) => (
  <svg
    className={className}
    aria-hidden="false"
    width="24"
...
export const DiscordAddIcon = ({ className }) => {
  return (
    <svg
      className={className}
      aria-hidden="true"
...
export const DiscordThreadsIcon = ({ className }) => {
  return (
    <svg
      x="0"
      y="0"
...
export const DiscordNotificationIcon = ({ className }) => {
  return (
    <svg
      x="0"
      y="0"
...
export const DiscordPinIcon = ({ className }) => {
  return (
    <svg
      x="0"
      y="0"
...
export const DiscordMemberIcon = ({ className }) => {
  return (
    <svg
      x="0"
      y="0"
...
export const DiscordInboxIcon = ({ className }) => {
  return (
    <svg
      x="0"
      y="0"
...
export const DiscordHelpIcon = ({ className }) => {
  return (
    <svg
      x="0"
      y="0"
...
export const DiscordSearchIcon = ({ className }) => {
  return (
    <svg
      className={className}
      aria-hidden="true"
...
export const DiscordCrossIcon = ({ className }) => {
  return (
    <svg
      className={className}
      aria-hidden="true"
...
export const DiscordMicIcon = ({ className }) => {
  return (
    <svg
      className={className}
      aria-hidden="true"
...
export const DiscordHeadsetIcon = ({ className }) => {
  return (
    <svg
      className={className}
      aria-hidden="true"
...
export const DiscordSettingsIcon = ({ className }) => {
  return (
    <svg
      className={className}
      aria-hidden="true"
